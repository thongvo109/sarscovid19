...
class CustomCasesChart extends StatelessWidget {
  final List<LineChartModel> lineCases;
  final bool animate;
...
//https://stackoverflow.com/questions/56437850/how-to-apply-linear-gradient-in-flutter-charts
    return [
      charts.Series<LineChartModel, DateTime>(
        id: "Cases",
        data: dataDeath,
        colorFn: (_, __) => charts.ColorUtil.fromDartColor(Color(0xFF666666)),
