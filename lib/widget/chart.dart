...
class CustomLineChart extends StatelessWidget {
  ...
  final List<LineChartModel> lineDeath;
...
//                .toString();
  ...
  List<charts.Series<LineChartModel, DateTime>> createLineChart() {
    ...
    final dataDeath = lineDeath;
    final dataRecovered = lineRecovered;
    return [
      ...
      charts.Series<LineChartModel, DateTime>(
        id: "Line",
        data: data,
        labelAccessorFn: (LineChartModel lineChart, _) =>
            lineChart.value.toString(),
...
//    );
    ...
    List tooltips = CustomLineChart.selectedDatum;
...
//          fill: charts.Color.fromHex(code: '#666666'));
      ...
      for (int i = 0; i < tooltips.length; i++) {
        canvas.drawPoint(
          point: Point(left.round() + 8, i * 15 + 25),
          radius: 3,
...
////            "Dương tính ${CustomLineChart.pointerValue}",
//            tooltips[i]['text'],
//            style: textStyle);
//
...
//        .round();
//    final num textElementBoundsTop = (bounds.top - 20).round();
//
